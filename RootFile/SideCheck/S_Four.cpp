...
void S_Four(
    ...
    if (RecordingMethod == 0) {
        for (RapIndex=0;RapIndex<yBinNum;RapIndex++) {
            ...
            D_ALL_phi_ABCD               [RapIndex] = new TH1D(Form("C_ALL_phi_ABCD_%d"      ,          RapIndex),Form("ALL %f<A_y<%f"      ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,SideSta,SideEnd);
            D_ALL_phi_A_B_C_D            [RapIndex] = new TH1D(Form("C_ALL_phi_A_B_C_D_%d"  ,          RapIndex), Form("ALL %f<A_y<%f"  ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,SideSta,SideEnd);
            D_ALL_phi_AB_CD              [RapIndex] = new TH1D(Form("C_ALL_phi_AB_CD_%d"  ,           RapIndex), Form("ALL %f<A_y<%f"  ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,SideSta,SideEnd);
            D_ALL_phi_AC_BD              [RapIndex] = new TH1D(Form("C_ALL_phi_AC_BD_%d"  ,           RapIndex), Form("ALL %f<A_y<%f"  ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,SideSta,SideEnd);
            D_ALL_phi_AD_BC              [RapIndex] = new TH1D(Form("C_ALL_phi_AD_BC_%d"  ,           RapIndex), Form("ALL %f<A_y<%f"  ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,SideSta,SideEnd);
            D_ALL_phi_ABC_D              [RapIndex] = new TH1D(Form("C_ALL_phi_ABC_D_%d"  ,           RapIndex), Form("ALL %f<A_y<%f"  ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,SideSta,SideEnd);
            D_ALL_phi_ABD_C              [RapIndex] = new TH1D(Form("C_ALL_phi_ABD_C_%d"  ,           RapIndex), Form("ALL %f<A_y<%f"  ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,SideSta,SideEnd);
            D_ALL_phi_ACD_B              [RapIndex] = new TH1D(Form("C_ALL_phi_ACD_B_%d"  ,           RapIndex), Form("ALL %f<A_y<%f"  ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,SideSta,SideEnd);
            D_ALL_phi_BCD_A              [RapIndex] = new TH1D(Form("C_ALL_phi_BCD_A_%d"  ,           RapIndex), Form("ALL %f<A_y<%f"  ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,SideSta,SideEnd);
            D_ALL_phi_AB_C_D             [RapIndex] = new TH1D(Form("C_ALL_phi_AB_C_D_%d"  ,           RapIndex), Form("ALL %f<A_y<%f"  ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,SideSta,SideEnd);
            D_ALL_phi_AC_B_D             [RapIndex] = new TH1D(Form("C_ALL_phi_AC_B_D_%d"  ,           RapIndex), Form("ALL %f<A_y<%f"  ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,SideSta,SideEnd);
            D_ALL_phi_AD_B_C             [RapIndex] = new TH1D(Form("C_ALL_phi_AD_B_C_%d"  ,           RapIndex), Form("ALL %f<A_y<%f"  ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,SideSta,SideEnd);
            D_ALL_phi_BC_A_D             [RapIndex] = new TH1D(Form("C_ALL_phi_BC_A_D_%d"  ,           RapIndex), Form("ALL %f<A_y<%f"  ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,SideSta,SideEnd);
            D_ALL_phi_BD_A_C             [RapIndex] = new TH1D(Form("C_ALL_phi_BD_A_C_%d"  ,           RapIndex), Form("ALL %f<A_y<%f"  ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,SideSta,SideEnd);
            D_ALL_phi_CD_A_B             [RapIndex] = new TH1D(Form("C_ALL_phi_CD_A_B_%d"  ,           RapIndex), Form("ALL %f<A_y<%f"  ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,SideSta,SideEnd);
            D_ALL_theta_ABCD             [RapIndex] = new TH1D(Form("C_ALL_theta_ABCD_%d"      ,      RapIndex),Form("ALL %f<A_y<%f"      ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,-1,1);
            D_ALL_theta_AB_CD            [RapIndex] = new TH1D(Form("C_ALL_theta_AB_CD_%d"      ,     RapIndex),Form("ALL %f<A_y<%f"      ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,-1,1);
            D_ALL_theta_AC_BD            [RapIndex] = new TH1D(Form("C_ALL_theta_AC_BD_%d"      ,     RapIndex),Form("ALL %f<A_y<%f"      ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,-1,1);
            D_ALL_theta_AD_BC            [RapIndex] = new TH1D(Form("C_ALL_theta_AD_BC_%d"      ,     RapIndex),Form("ALL %f<A_y<%f"      ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,-1,1);
            D_ALL_theta_A_B_C_D          [RapIndex] = new TH1D(Form("C_ALL_theta_A_B_C_D_%d"  ,      RapIndex), Form("ALL %f<A_y<%f"  ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,-1,1);
            D_ALL_theta_ABC_D            [RapIndex] = new TH1D(Form("C_ALL_theta_ABC_D_%d"      ,     RapIndex),Form("ALL %f<A_y<%f"      ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,-1,1);
            D_ALL_theta_ABD_C            [RapIndex] = new TH1D(Form("C_ALL_theta_ABD_C_%d"      ,     RapIndex),Form("ALL %f<A_y<%f"      ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,-1,1);
            D_ALL_theta_ACD_B            [RapIndex] = new TH1D(Form("C_ALL_theta_ACD_B_%d"      ,     RapIndex),Form("ALL %f<A_y<%f"      ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,-1,1);
            D_ALL_theta_BCD_A            [RapIndex] = new TH1D(Form("C_ALL_theta_BCD_A_%d"      ,     RapIndex),Form("ALL %f<A_y<%f"      ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,-1,1);
            D_ALL_theta_AB_C_D           [RapIndex] = new TH1D(Form("C_ALL_theta_AB_C_D_%d"      ,     RapIndex),Form("ALL %f<A_y<%f"      ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,-1,1);
            D_ALL_theta_AC_B_D           [RapIndex] = new TH1D(Form("C_ALL_theta_AC_B_D_%d"      ,     RapIndex),Form("ALL %f<A_y<%f"      ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,-1,1);
            D_ALL_theta_AD_B_C           [RapIndex] = new TH1D(Form("C_ALL_theta_AD_B_C_%d"      ,     RapIndex),Form("ALL %f<A_y<%f"      ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,-1,1);
            D_ALL_theta_BC_A_D           [RapIndex] = new TH1D(Form("C_ALL_theta_BC_A_D_%d"      ,     RapIndex),Form("ALL %f<A_y<%f"      ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,-1,1);
            D_ALL_theta_BD_A_C           [RapIndex] = new TH1D(Form("C_ALL_theta_BD_A_C_%d"      ,     RapIndex),Form("ALL %f<A_y<%f"      ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,-1,1);
            D_ALL_theta_CD_A_B           [RapIndex] = new TH1D(Form("C_ALL_theta_CD_A_B_%d"      ,     RapIndex),Form("ALL %f<A_y<%f"      ,yBin[RapIndex],yBin[RapIndex+1]),SideBinNum,-1,1);
