...
while ($i <= $numFiles)
    ...
    set RightBrackets = "\)"
    set Quo = '\"'
    echo ./S_One \"\$FILELIST\" \"$DataName\" \$OutputFileIndex \"$OutputName\" $A_PDG $B_PDG $C_PDG 0 $SLMEIndex $RecordingMethod $CutIndex >> $SubXml
...
echo This is $A_PDG - $B_PDG - $C_PDG Corralation