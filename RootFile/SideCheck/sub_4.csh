...
set C_PDG = "$<"
echo "Please enter particle D PDG:"
set D_PDG = "$<"
...
echo "SCHEME 2: /star/data01/pwg/svianping/Side_"$A_PDG"_"$B_PDG"_"$C_PDG"_"$D_PDG"/HADD_T_*.root"
echo "SCHEME 3: /star/data01/pwg/svianping/Side_"$A_PDG"_"$B_PDG"_"$C_PDG"_"$D_PDG"/HADDrA_*.root"
...
if ($InputNameIndex == 1) then
    ...
    set OutPutPath = "/star/data01/pwg/svianping/Side_"$A_PDG"_"$B_PDG"_"$C_PDG"_"$D_PDG"/"
    ...
    set InPutPath = "/star/data01/pwg/svianping/Side_"$A_PDG"_"$B_PDG"_"$C_PDG"_"$D_PDG"/"
...
if ($InputNameIndex == 1) then
    ...
    set ObvOutputName = "/star/data01/pwg/svianping/Side_"$A_PDG"_"$B_PDG"_"$C_PDG"_"$D_PDG"/HADD_"
    # set ObvOutputName = "/star/data01/pwg/svianping/Side_"$A_PDG"_"$B_PDG"/HADD_"
    set InputName = "output_"
    set OutputName = "HADD_"
    set OutputURL = "/star/data01/pwg/svianping/Side_"$A_PDG"_"$B_PDG"_"$C_PDG"_"$D_PDG"/"
    # set OutputURL = "/star/data01/pwg/svianping/Side_"$A_PDG"_"$B_PDG"/"
    rm -rf $OutPutPath
    mkdir $OutPutPath
    mkdir /star/data01/pwg/svianping/Side_"$A_PDG"_"$B_PDG"_"$C_PDG"_"$D_PDG"/log/
...
while ($i <= $numFiles)
    ...
    # set SubXml=sub.xml
    set SubXml="/star/data01/pwg/svianping/Side_"$A_PDG"_"$B_PDG"_"$C_PDG"_"$D_PDG"/sub.xml"
    set RootList="/star/data01/pwg/svianping/Side_"$A_PDG"_"$B_PDG"_"$C_PDG"_"$D_PDG"/sub_$i.list"
    ...
    echo set D_PDG = $D_PDG >> $SubXml
    set LeftBrackets = "\("
    set RightBrackets = "\)"
    set Quo = '\"'
    echo ./S_One \"\$FILELIST\" \"$DataName\" \$OutputFileIndex \"$OutputName\" $A_PDG $B_PDG $C_PDG $D_PDG 0 $SLMEIndex $RecordingMethod $CutIndex >> $SubXml
    ...
    echo \</Package\> >> $SubXml
    echo \</SandBox\> >> $SubXml
    echo \<stdout URL=\"file:/star/data01/pwg/svianping/Side\_$A_PDG\_$B_PDG\_$C_PDG\_$D_PDG/log/script\_$i\.out\" /\> >> $SubXml
...
echo This is $A_PDG - $B_PDG - $C_PDG - $D_PDG Corralation