...
void cHADD()
{
    ...
    TH1F *Result1 = (TH1F*)h1->Clone("Merge_merge_Lambda");
    TH1F *Result2 = (TH1F*)h2->Clone("Merge_merge_Lambdab");
    TH1F *Result3 = (TH1F*)h3->Clone("Merge_merge_Omega");
    TH1F *Result4 = (TH1F*)h4->Clone("Merge_merge_Omegab");
    TH1F *Result5 = (TH1F*)h5->Clone("Merge_merge_DaughtersDCA_Lambda");
    TH1F *Result6 = (TH1F*)h6->Clone("Merge_merge_DaughtersDCA_Lambdab");
    TH1F *Result7 = (TH1F*)h7->Clone("Merge_merge_DaughtersDCA_Omega");
    TH1F *Result8 = (TH1F*)h8->Clone("Merge_merge_DaughtersDCA_Omegab");
    Result1->Reset();
    Result1->Merge(list1);
    Result2->Reset();
    Result2->Merge(list2);
    ...
    Result1->Write("Merge_merge_Lambda");
    Result2->Write("Merge_merge_Lambdab");
    Result3->Write("Merge_merge_Omega");
    Result4->Write("Merge_merge_Omegab");
    Result5->Write("Merge_merge_DaughtersDCA_Lambda");
    Result6->Write("Merge_merge_DaughtersDCA_Lambdab");
    Result7->Write("Merge_merge_DaughtersDCA_Omega");
    Result8->Write("Merge_merge_DaughtersDCA_Omegab");
