...
echo "SCHEME 2: /star/data01/pwg/svianping/NR/HADD_T_*.root"
echo "SCHEME 3: /star/data01/pwg/svianping/NR/HADDrA_*.root"
set InputNameIndex = "$<"


if ($InputNameIndex == 1) then

    set OutPutPath = "/star/data01/pwg/svianping/NR/"
    ...
    set InPutPath = "/star/data01/pwg/svianping/NR/"
    cd $InPutPath
...
if ($InputNameIndex == 1) then
    ...
    set ObvOutputName = "/star/data01/pwg/svianping/NR/HADD_"
    set InputName = "output_"
    set OutputName = "HADD_"
    set OutputURL = "/star/data01/pwg/svianping/NR/"
    rm -rf $OutPutPath
    mkdir $OutPutPath
    mkdir /star/data01/pwg/svianping/NR/log/
else if ($InputNameIndex == 2) then
    set ObvInputName = "/star/data01/pwg/svianping/NR/HADD_T_"
    set ObvOutputName = "/star/data01/pwg/svianping/NR/HADDr_"
    set InputName = "HADD_T_"
    set OutputName = "HADDr_"
    set OutputURL = "/star/data01/pwg/svianping/NR/"
else if ($InputNameIndex == 3) then
    set ObvInputName = "/star/data01/pwg/svianping/NR/HADDrA_"
...
while ($i <= $numFiles)
    ...
    # set SubXml=sub.xml
    set SubXml="/star/data01/pwg/svianping/NR/sub.xml"
    ...
    echo \</Package\> >> $SubXml
    echo \</SandBox\> >> $SubXml
    echo \<stdout URL=\"file:/star/data01/pwg/svianping/NR/log/script\_$i\.out\" /\> >> $SubXml
