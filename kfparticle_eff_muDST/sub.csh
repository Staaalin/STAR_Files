...
# echo \<input URL=\"catalog:star\.bnl\.gov\?production=P21ic,filetype=daq_reco_picoDst,trgsetupname~production_19GeV_2019,sanity=1,tpx=1,storage!=hpss,filename~st_physics\" nFiles=\"$nFileTotal\" /\> >> $SubXml
echo \<input URL=\"filelist:/star/data01/pwg/xiatong/git/kfparticle_eff_27GeV/datalist/run18List27_MC_lambdabar_exp.list\" /\> >> $SubXml
