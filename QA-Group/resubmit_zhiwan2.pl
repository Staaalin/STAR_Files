...
"/star/data01/pwg/zhiwanxu/QA-group/11GeV/P23ia_QA_run1/cen0"
#"/star/data01/pwg/zhiwanxu/QA-group/11GeV/P23ia_cen_run1/cen0"
...
# my @tempFinished = glob( "$jobDir/sched*$eachCent.ga*.root" ) ;
