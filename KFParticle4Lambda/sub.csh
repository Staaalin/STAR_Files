...
# echo \<input URL=\"catalog:star\.bnl\.gov\?production=P17id,filetype=daq_reco_PicoDst,trgsetupname~dAu200_production_2016,runnumber\[\]17132061-17141003,sanity=1,tpx=1,storage!=hpss,filename~st_physics\" nFiles=\"$nFileTotal\" /\> >> $SubXml
...
echo \<input URL=\"filelist:/star/u/svianping/STAR_Files/KFParticle4Lambda/datalist/19.6GeV_Run19/19.6.list.Kplus_embed\" \/\> >> $SubXml
