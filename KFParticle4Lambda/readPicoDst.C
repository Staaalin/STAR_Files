...
void readPicoDst(const Char_t *inputFile="test.list", int jobindex, int run=11, float energy=200.0, Char_t *ListDir="./datalist/")
{
	...
	TString StrOutName = "output_"; StrOutName += iJob; StrOutName += ".root";
	...
	TString outputKFParticleQA = "KFParticleQA_"; outputKFParticleQA += iJob; outputKFParticleQA += ".root";
	...
	StKFParticleInterface::instance()->SetChi2TopoCutXiOmega(10);
